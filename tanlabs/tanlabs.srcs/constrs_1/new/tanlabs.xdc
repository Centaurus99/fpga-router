...
# input setup delay = 10ns(read) - 10ns(clock period) - (-2.7ns)(output delay) + 1.8ns(pcb route time)
...
set_output_delay -clock clk_out2_clk_wiz_0 -max -2.700 [get_ports {ext_ram_data[*]}]
set_output_delay -clock clk_out2_clk_wiz_0 -max -2.700 [get_ports {ext_ram_addr[*]}]
set_output_delay -clock clk_out2_clk_wiz_0 -max -2.700 [get_ports {ext_ram_be_n[*]}]
set_output_delay -clock clk_out2_clk_wiz_0 -max -2.700 [get_ports ext_ram_ce_n]
set_output_delay -clock clk_out2_clk_wiz_0 -max -2.700 [get_ports ext_ram_oe_n]
...
set_output_delay -clock clk_out2_clk_wiz_0 -min -2.700 [get_ports ext_ram_we_n]
